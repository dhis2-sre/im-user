...
func (m *DeletedAt) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 NullTime
...
func (m DeletedAt) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 1)

	aO0, err := swag.WriteJSON(m.NullTime)
	if err != nil {
		return nil, err
	}
...
// ContextValidate validate this deleted at based on the context it is used
