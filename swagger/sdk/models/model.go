...
// Model Model a basic GoLang struct which includes the following fields: ID, CreatedAt, UpdatedAt, DeletedAt
...
func (m *Model) validateDeletedAt(formats strfmt.Registry) error {
...
func (m *Model) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *Model) contextValidateDeletedAt(ctx context.Context, formats strfmt.Registry) error {
